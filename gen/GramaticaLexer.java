...
public class GramaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "TIPODATOS", "LITERAL", "ARIMETICOS", "NUMERO", "PUNCOM", "SIGNOS", 
			"MULTIOPER", "ID", "OPER_COND", "LETTER", "DIGIT", "UNDERSCORE", "String", 
			"Int", "Double", "Boolean", "Disc", "Lt", "LtEqual", "GtEqual", "Gt", 
			"Equal", "SUM", "REST", "MUL", "DIV", "COMA", "PUNTO", "NEWLINE"
		};
	}
